...
IMPL_SPLIT_COMBINE_EWBINARYOP(MorphAddOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(MorphSubOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(MorphMulOp)
IMPL_SPLIT_COMBINE_EWBINARYOP(MorphDivOp)
...
IMPL_SPLIT_COMBINE_EWBINARYOP(MorphAndOp)
